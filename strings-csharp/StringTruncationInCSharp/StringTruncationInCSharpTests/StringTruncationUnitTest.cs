...
namespace StringTruncationInCSharpTests
{
    public class StringTruncationTests
    {
        ...
        private static readonly int LengthLongerThanOriginalString = OriginalString.Length + 10;
        ...
        {
            var truncatedString = StringHelper.TruncateWithSubstring(OriginalString, LengthLongerThanOriginalString);
        ...
        {
            var truncatedString = StringHelper.TruncateWithForLoopStringBuilder(OriginalString, LengthLongerThanOriginalString);
        ...
        {
            var truncatedString = StringHelper.TruncateWithRegularExpressions(OriginalString, LengthLongerThanOriginalString);
        ...
        {
            var truncatedString = StringHelper.TruncateWithRemove(OriginalString, LengthLongerThanOriginalString);
        ...
        {
            var truncatedString = StringHelper.TruncateWithLINQ(OriginalString, LengthLongerThanOriginalString);
        ...
        {
            var truncatedString = StringHelper.TruncateWithSpan(OriginalString, LengthLongerThanOriginalString);
